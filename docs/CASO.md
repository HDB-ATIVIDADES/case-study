...
Nesta etapa, você deve analisar o código-fonte base fornecido para o sistema e adaptá-lo ou modificá-lo de modo que possa ser executado em um container Docker. Em um exercício real também seria necessário adaptar o código aos requisitos identificados na etapa 1 porém, adaptaremos apenas o ambiente de execução em container, sem necessariamente implementar todos os requisitos definidos na Etapa 1. Confira as versões e atualizações das ferramentas compatíveis com aplicação.
